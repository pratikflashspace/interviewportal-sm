...
DESIGN_SCREENING = rows('design-screen', 'domain', 'screening', [
 ('You are asked to coordinate with the vendors or find a vendor for the turnkey of a renovation project. What steps would you take to make sure you get the best vendor for the project?',
 ...
 ('This role would include redesigning the interior of the space using AutoCAD and other tools, plus right coordination with interior vendors and other vendors as required, and looking over the entire project. Is this okay with you?',
 ...
 ('Are you available for at least 6 months?',
  ['When would you be available to start?',
   'Do you have any academic or other commitments that could affect your availability?']),
 ('We have a stipend structure of INR 10,000 to INR 15,000 per month. Is that okay for you?',
...
DESIGN_ASSESS = {
    'design-screen-1': 'Vendor sourcing, evaluation, negotiation, and selection process for turnkey renovation projects.',
    'design-screen-2': 'Role understanding, tool proficiency (AutoCAD), ownership, and willingness to handle project responsibilities.',
    'design-screen-3': 'Availability and commitment for at least 6 months.',
    'design-screen-4': 'Compensation alignment with the INR 10,000-15,000 stipend structure.',
    ...
    'design-c-2': 'Space optimization, problem-solving, functionality, and communication.',
    'design-c-3': 'Budget awareness, prioritization, creativity, cost-effective design, and decision-making.',
    'design-c-4': 'Communication, handling feedback, design justification, adaptability, and professional judgment.',
    'design-c-5': 'Creativity, visual thinking, research, brand understanding, and presentation skills.',
    'design-c-6': 'Collaboration, execution awareness, problem-solving, adaptability, follow-through, and decision-making.',
    'design-c-7': 'Organization, project coordination, vendor management, prioritization, and communication.',
    'design-c-8': 'Practical design thinking, usability, critical thinking, and willingness to iterate.',
    'design-c-9': 'Learning ability, initiative, research, design process, tool usage, problem-solving, and ownership.',
}
